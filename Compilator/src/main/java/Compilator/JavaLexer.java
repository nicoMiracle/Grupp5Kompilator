...
public class JavaLexer {
    ...
    public JavaLexer() {
        charTokenMap.put('{', TokenType.LEFT_BRACE);
        charTokenMap.put('}', TokenType.RIGHT_BRACE);
        ...
        while (currentPosition < input.length()) {
            ...
            if (charTokenMap.containsKey(currentChar)) {
                ...
                switch (letter) {
                    ...
                    case "if" -> tokenList.add(new Token(TokenType.CONTROL_IF, letter, lineNumber));
                    case "while" -> tokenList.add(new Token(TokenType.CONTROL_WHILE, letter, lineNumber));
